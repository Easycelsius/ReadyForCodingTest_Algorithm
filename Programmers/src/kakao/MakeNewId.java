 ...
 * 
 * 후기
 *  - 막혔던 부분은 2번이었고 2번으로 인해, 뒤쪽에 substring 사용하는 부분에서 추가로 코드를 작성하였음
 *  - 정규표현식을 사용하는 방법도 좋아보이지만, 난이도상 정규표현식을 배제하고 사용하였음
 *  - 상당히 시간이 많이 걸리는 작업이었던 것 같음
 *  - 문자열을 하나씩 추출할 때는 charAt을 적극 활용해야 할 것 같음
 */
